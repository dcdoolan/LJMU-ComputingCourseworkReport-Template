...
\begin{document}
\input{titlepage} % Edit the file titlepage.tex to update the Title Page
\clearpage
\singlespacing
...
\include{howToGuide} % Add a Percentage Symbol at the start of this line to remove the "How To Guide" from out Compiled pdf
